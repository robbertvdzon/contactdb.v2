...
docker run -d -it -p $HAPROXY_PORT:80 --name $DOCKERNAME_HAPROXY --link $DOCKERNAME_APACHE_A:apache1 --link $DOCKERNAME_APACHE_A:apache2 robbertvdzon/$DOCKERNAME_HAPROXY
