...
docker run -d -it -p 82:82 -p 81:81 --name $DOCKERNAME_HAPROXY --link $DOCKERNAME_APACHE_A:apache1 --link $DOCKERNAME_APACHE_A:apache2 robbertvdzon/$DOCKERNAME_HAPROXY
